...
DEFAULT_WATERING_DELAY = 0  # minutes, should be 0; if not null, useful for testing so the user can cancel before water actually starts
...
MAX_WATERING_DELAY = 1440  # minutes (24h)
